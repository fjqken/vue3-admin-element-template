...
export const asyncRoutes = [
  ...
  {
    path: '/interface_testing',
    name: 'interface_testing',
    component: Layout,
    meta: {
      title: global.t('route.interface_testing'),
    ...
    children: [
      {
        path: '/interface_list',
        name: 'interface_list',
        component: () => import('@/views/interface_testing/interface_list.vue'),
        meta: {
          title: global.t('route.interface_list'),
          icon: 'icon-link-cloud-faild',
        },
      },
      {
